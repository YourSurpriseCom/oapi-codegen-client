...
require (
	...
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/api/v2 v2.10.1 // indirect
	github.com/DataDog/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.10.1 // indirect
	github.com/DataDog/dd-trace-go/contrib/jmoiron/sqlx/v2 v2.10.1 // indirect
