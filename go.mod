...
require (
	github.com/YourSurpriseCom/go-datadog-apm/v2 v2.4.1
...
require (
	...
	github.com/DataDog/dd-trace-go/contrib/google.golang.org/api/v2 v2.7.3 // indirect
	github.com/DataDog/dd-trace-go/contrib/gorm.io/gorm.v1/v2 v2.7.3 // indirect
	github.com/DataDog/dd-trace-go/contrib/jmoiron/sqlx/v2 v2.7.3 // indirect
